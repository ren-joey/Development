	...
	$('#fullpage').fullpage({
        ...
        onLeave: function(index, nextIndex, direction){
            ...
            if(index == 1 && direction =='down') {
				...
				$('#ten-thousand-case, .case-1').removeClass('active');
				$('#mountainside-case, .case-4').addClass('active');
				$('#prev, #next, .check-it-out').removeClass('bg-light-gray');	
            ...
            //after leaving Mr. C Hotel
				...
				$('#mr-c-case, .case-2').removeClass('active');
				$('#nathan-adelson-case, .case-3').addClass('active');
				...
				$('.check-it-out a').removeClass('gray');
				$('.check-it-out a').addClass('white');
				$('.swipe-bg.bg-white, .swipe-bg.bg-red').removeClass('active');
            ...
            //after leaving Nathan Adelson
				...
				$('#nathan-adelson-case, .case-3').removeClass('active');
				$('#mountainside-case, .case-4').addClass('active');
            ...
            //after leaving Mountainside
				...
				$('#mountainside-case, .case-4').removeClass('active');
				$('#ten-thousand-case, .case-1').addClass('active');
				...
				$('.mr-c-screen, .nathan-adelson-screen, .mountainside-screen').removeClass('active');
            }
